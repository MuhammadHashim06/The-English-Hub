    ...
    <div className="goals">
      <div className="goal-section">
        ...
        <div className="imagesection">
          ...
          <div className="card">
            <video
              src={goalsData.sections[0].card2.imgUrl}
              alt="Card 2"
              autoPlay="true"
              loop="true"
            />
      ...
      <div className="goal-section">
        <div className="uppercontent">
          ...
          <Link to={"/signup"}>
            {" "}
            <button>{goalsData.sections[1].buttonText}</button>
          </Link>
        </div>
      ...
      <div className="goal-section">
        <div className="uppercontent">
          ...
          <Link to={"/signup"}>
            <button>{goalsData.sections[2].buttonText}</button>
          </Link>
        </div>
        <div className="imagesection">
          <div className="card">
      ...
      <div className="goal-section">
        ...
        <div className="imagesection">
          ...
          <div className="card">
            <video
              src={goalsData.sections[3].card2.imgUrl}
              alt="Card 2"
              autoPlay="true"
              loop="true"
            />
